...
public class Binding1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   * 4. 저장 영역
	   *   1) ServletContext     : 컨텍스트(프로젝트, 애플리케이션) 종료 전까지 값을 저장할 수 있다. 애플리케이션이 실행중이라면 어디서든 값을 접근할 수 있다.
	   *   2) HttpSession        : 세션 종료 전까지 값을 저장할 수 있다. 웹 브라우저가 실행중이라면 어디서든 값에 접근할 수 있다.
	   ...
	   *   2) getAttribute("속성")     : Object 타입의 값을 반환한다. 캐스팅이 필요 할 수 있다.
	  ...
	  // Binding2 서블릿으로 이동(HtppsServletRequest의 전달이 가능한 forward를 이용)
